#ifndef DIV_BY_160_INCLUDED
#define DIV_BY_160_INCLUDED
...
__value_in_regs
div_t
div_by_160_qr(register unsigned d_)
{
  register div_t rv;
...
__pure
unsigned
div_by_160_q(register unsigned d_)
{
  register div_t rv;
  register unsigned tmp;
...
__pure
unsigned
div_by_160_r(register unsigned d_)
{
  register div_t rv;
  register unsigned tmp;
