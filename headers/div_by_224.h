#ifndef DIV_BY_224_INCLUDED
#define DIV_BY_224_INCLUDED
...
__value_in_regs
div_t
div_by_224_qr(register unsigned d_)
{
  register div_t rv;
...
__pure
unsigned
div_by_224_q(register unsigned d_)
{
  register div_t rv;
  register unsigned tmp;
...
__pure
unsigned
div_by_224_r(register unsigned d_)
{
  register div_t rv;
  register unsigned tmp;
