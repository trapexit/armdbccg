#ifndef DIV_BY_192_INCLUDED
#define DIV_BY_192_INCLUDED
...
__value_in_regs
div_t
div_by_192_qr(register unsigned d_)
{
  register div_t rv;
...
__pure
unsigned
div_by_192_q(register unsigned d_)
{
  register div_t rv;
  register unsigned tmp;
...
__pure
unsigned
div_by_192_r(register unsigned d_)
{
  register div_t rv;
  register unsigned tmp;
